...
const ResponsableFiliereDashboard = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-100">
            <Sidebar role="Responsable Filiere" />
            <div className="flex-1 p-8 overflow-y-auto">
                <h1 className="text-3xl font-bold mb-8">Espace Responsable Filière</h1>
...
export default ResponsableFiliereDashboard;
